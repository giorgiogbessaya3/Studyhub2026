...
<head>
    ...
    <title>Kounde Avocats - Droit Bancaire</title>
    <style>
        .expertise-page-body {
    ...
    <section class="expertise-hero-section">
        <div class="container  text-center expertise-hero-content">
            <h1 class="expertise-hero-title mb-3">
                <i class="fas fa-landmark me-3"></i>Droit <span class="text-orange">Bancaire</span>
            </h1>
            <p class="expertise-hero-breadcrumb">
                <i class="fas fa-home me-2"></i>Accueil / <i class="fas fa-gavel me-2"></i>Expertises / <span class="text-orange">Droit Bancaire</span>
            </p>
        </div>
    </section>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4">
                    <div class="expertise-sidebar">
                        ...
                        <div class="sidebar-block-list mb-4">
                            ...
                            <a href="{{url('/droitimmobillier')}}" class="sidebar-expertise-link">
                                <i class="fas fa-building me-2"></i>Droit Immobilier
                                <i class="fas fa-arrow-right"></i>
                            </a>
                            <a href="{{url('/droitconstruction')}}" class="sidebar-expertise-link">
                                <i class="fas fa-shopping-cart me-2"></i>Droit de consommation
                                <i class="fas fa-arrow-right"></i>
                            </a>
                            <a href="{{url('/droitconstruction')}}" class="sidebar-expertise-link">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="expertise-main-image mb-4">
                        <img src="img/bancaire.png" alt="Droit Bancaire" class="img-fluid rounded">
                    </div>

                    <div class="expertise-description">
                        <p>
                            <i class="fas fa-gavel text-orange me-2"></i>
                            Le droit bancaire régit les relations entre les établissements financiers et leurs clients, qu'il s'agisse de particuliers ou d'entreprises. Notre cabinet intervient dans les litiges relatifs aux crédits, aux moyens de paiement, aux cautions ou encore aux opérations bancaires complexes.
                        </p>
                        <p>
                            <i class="fas fa-shield-alt text-orange me-2"></i>
                            Nous vous assistons pour sécuriser vos transactions et défendre vos droits face aux institutions financières. Notre expertise couvre l'ensemble des problématiques bancaires : surendettement, litiges contractuels, exécution des garanties, et contentieux divers.
                        </p>
                        <p>
                            <i class="fas fa-handshake text-orange me-2"></i>
                            Nous privilégions une approche claire et pragmatique, permettant d'anticiper les risques et de résoudre rapidement les différends. Que vous soyez confronté à un litige bancaire ou que vous cherchiez à prévenir tout contentieux, nous vous accompagnons avec expertise et efficacité.
                        </p>
                    </div>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                    ...
                    <div class="process-steps">
                        ...
                        <div class="step-item">
                            ...
                            <div class="step-content">
                                <h4 class="step-title">Consultation Initiale Personnalisée</h4>
                                <p class="step-description">
                                    Nous évaluons ensemble votre situation lors d'un premier échange approfondi et confidentiel pour comprendre vos besoins spécifiques.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="step-item">
                            ...
                            <div class="step-content">
                                ...
                                <p class="step-description">
                                    Je conçois une défense ou un conseil sur mesure, adapté à vos objectifs spécifiques et à la complexité de votre dossier.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="step-item">
                            ...
                            <div class="step-content">
                                ...
                                <p class="step-description">
                                    Je reste à vos côtés à chaque étape, garantissant un suivi rigoureux jusqu'à la résolution complète de votre dossier.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 text-center position-relative">
                    <img src="img/ima.png" alt="Processus juridique" class="img-fluid process-image-expertise-page rounded">
                    ...
                    <div class="process-stats-block-expertise-page">
                        ...
                        <div class="stat-item-expertise border-start">
                            <span class="stat-number-expertise">200+</span>
                            <span class="stat-label-expertise">Clients Satisfaits</span>
                        </div>
                    </div>
            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-5">
                    <div class="why-us-image-wrapper">
                        <img src="img/reu2.png" alt="Maître Koundé parlant" class="img-fluid why-us-image rounded">
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    ...
                    <h2 class="why-us-main-title mb-4">
                        Défendre vos <span class="highlight-orange">intérêts</span>, notre mission
                    </h2>
                    <a href="#" class="btn btn-primary d-inline-block mb-4 d-lg-none">
                        <i class="fas fa-comments me-2"></i>Contactez-nous
                    </a>
                    ...
                    <div class="row row-cols-md-2 g-4">
                        ...
                        <div class="col">
                            <div class="advantage-card">
                                ...
                                <h4 class="card-title">Expertise avérée</h4>
                                <p class="card-description">
                                    Plus de 20 ans d'expérience au service de la défense de vos droits et intérêts dans le domaine bancaire.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="advantage-card">
                                ...
                                <p class="card-description">
                                    Je conçois des stratégies personnalisées, adaptées à votre situation unique et aux spécificités bancaires.
                                </p>
                            </div>
                        </div>
            ...
            <div class="accordion" id="faqAccordion">
                ...
                <div class="accordion-item faq-item">
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button collapsed faq-question" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                            ...
                            Quels types de dossiers bancaires votre cabinet prend-il en charge ?
                        </button>
                    </h2>
                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                        <div class="accordion-body faq-answer">
                            Notre cabinet est spécialisé dans tous les aspects du droit bancaire : litiges de crédit, surendettement, contentieux des moyens de paiement, exécution des garanties, relations avec les établissements financiers, et conseil en conformité bancaire.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item faq-item">
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                        <div class="accordion-body faq-answer">
                            Veuillez apporter tous les documents pertinents à votre dossier bancaire : contrats de prêt, relevés bancaires, correspondances avec votre banque, avis d'échéance, jugements précédents, etc. Cela nous aidera à évaluer votre situation avec la plus grande précision.
                        </div>
                    </div>
                </div>
