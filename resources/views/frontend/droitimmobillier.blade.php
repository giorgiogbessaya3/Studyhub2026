...
<head>
    ...
    <title>Kounde Avocats - Droit Immobilier</title>
    <style>
        .expertise-page-body {
    ...
    <section class="expertise-hero-section">
        <div class="container  text-center expertise-hero-content">
            <h1 class="expertise-hero-title mb-3">
                <i class="fas fa-building me-3"></i>Droit <span class="text-orange">Immobilier</span>
            </h1>
            <p class="expertise-hero-breadcrumb">
                <i class="fas fa-home me-2"></i>Accueil / <i class="fas fa-gavel me-2"></i>Expertises / <span class="text-orange">Droit Immobilier</span>
            </p>
        </div>
    </section>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="expertise-main-image mb-4">
                        <img src="img/imobil.png" alt="Droit Immobilier" class="img-fluid rounded">
                    </div>

                    <div class="expertise-description">
                        <p>
                            <i class="fas fa-gavel text-orange me-2"></i>
                            Le droit immobilier encadre l'ensemble des transactions et litiges liés aux biens immobiliers : achat, vente, location, copropriété, construction, etc. Notre cabinet vous accompagne dans toutes vos démarches immobilières, qu'il s'agisse de particuliers ou de professionnels.
                        </p>
                        <p>
                            <i class="fas fa-shield-alt text-orange me-2"></i>
                            Nous intervenons pour sécuriser vos transactions immobilières, rédiger et analyser vos contrats, et défendre vos droits face aux différents acteurs du secteur. Notre expertise couvre les contentieux de vente, les litiges de construction, les problèmes de copropriété et les relations propriétaires-locataires.
                        </p>
                        <p>
                            <i class="fas fa-handshake text-orange me-2"></i>
                            Nous privilégions une approche claire et pragmatique, permettant d'anticiper les risques et de résoudre rapidement les différends. Que vous soyez confronté à un litige immobilier ou que vous cherchiez à sécuriser une transaction, nous vous accompagnons avec expertise et efficacité.
                        </p>
                    </div>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                    ...
                    <div class="process-steps">
                        ...
                        <div class="step-item">
                            ...
                            <div class="step-content">
                                <h4 class="step-title">Analyse Initiale de Votre Dossier</h4>
                                <p class="step-description">
                                    Nous examinons ensemble votre situation immobilière lors d'un premier échange approfondi pour comprendre vos objectifs et les enjeux spécifiques.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="step-item">
                            ...
                            <div class="step-content">
                                <h4 class="step-title">Élaboration de la Stratégie Juridique</h4>
                                <p class="step-description">
                                    Je conçois une approche sur mesure, adaptée à votre situation immobilière spécifique, qu'il s'agisse de transaction, de litige ou de conseil préventif.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="step-item">
                            ...
                            <div class="step-content">
                                <h4 class="step-title">Accompagnement Constant et Réactif</h4>
                                <p class="step-description">
                                    Je reste à vos côtés à chaque étape de votre projet immobilier, garantissant un suivi rigoureux jusqu'à la résolution complète de votre dossier.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 text-center position-relative">
                    <img src="img/reu1.png" alt="Processus juridique immobilier" class="img-fluid process-image-expertise-page rounded">
                    ...
                    <div class="process-stats-block-expertise-page">
                        ...
                        <div class="stat-item-expertise border-start">
                            <span class="stat-number-expertise">500+</span>
                            <span class="stat-label-expertise">Dossiers Immobiliers</span>
                        </div>
                    </div>
            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-5">
                    <div class="why-us-image-wrapper">
                        <img src="img/kj.png" alt="Maître Koundé parlant" class="img-fluid why-us-image rounded">
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    ...
                    <h2 class="why-us-main-title mb-4">
                        Sécuriser vos <span class="highlight-orange">projets immobiliers</span>, notre mission
                    </h2>
                    <a href="#" class="btn btn-primary d-inline-block mb-4 d-lg-none">
                        <i class="fas fa-comments me-2"></i>Contactez-nous
                    </a>
                    ...
                    <div class="row row-cols-md-2 g-4">
                        ...
                        <div class="col">
                            <div class="advantage-card">
                                ...
                                <h4 class="card-title">Expertise spécialisée</h4>
                                <p class="card-description">
                                    Plus de 20 ans d'expérience au service de vos projets immobiliers, de la simple transaction aux contentieux complexes.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="advantage-card">
                                ...
                                <h4 class="card-title">Stratégie efficace</h4>
                                <p class="card-description">
                                    Je conçois des stratégies personnalisées, adaptées à votre situation unique et aux spécificités du marché immobilier.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="advantage-card">
                                ...
                                <h4 class="card-title">Approche Humaine</h4>
                                <p class="card-description">
                                    Pour chaque client, je privilégie l'écoute, la bienveillance et la transparence dans nos échanges.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="advantage-card">
                                ...
                                <p class="card-description">
                                    Je m'engage à vos côtés jusqu'à la résolution complète de votre dossier, avec détermination et professionnalisme.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="accordion" id="faqAccordion">
                ...
                <div class="accordion-item faq-item">
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button collapsed faq-question" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                            ...
                            Quels types de dossiers immobiliers votre cabinet prend-il en charge ?
                        </button>
                    </h2>
                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                        <div class="accordion-body faq-answer">
                            Notre cabinet est spécialisé dans tous les aspects du droit immobilier : transactions immobilières, litiges de vente, contentieux de construction, problèmes de copropriété, baux d'habitation et commerciaux, expropriation, servitudes, et conseil en investissement immobilier.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item faq-item">
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                        <div class="accordion-body faq-answer">
                            Veuillez apporter tous les documents pertinents à votre dossier immobilier : contrats de vente ou de location, diagnostics techniques, règlements de copropriété, correspondances avec les autres parties, jugements précédents, etc. Cela nous aidera à évaluer votre situation avec la plus grande précision.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item faq-item">
                    ...
                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
                        <div class="accordion-body faq-answer">
                            Nos honoraires sont fixés en toute transparence, généralement au forfait ou au temps passé, en fonction de la complexité de votre dossier. Une estimation détaillée vous sera fournie dès la première consultation. Nous proposons également des solutions de paiement échelonné pour certains types de dossiers.
                        </div>
                    </div>
                </div>
