    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="group relative" data-aos="fade-up" data-aos-delay="0">
                ...
                <a href="{{ route('classes') }}" class="relative block bg-white rounded-3xl p-8 shadow-lg border border-slate-100 card-hover overflow-hidden">
            ...
            <div class="group relative" data-aos="fade-up" data-aos-delay="100">
                ...
                <a href="{{ route('epreuves') }}" class="relative block bg-white rounded-3xl p-8 shadow-lg border border-slate-100 card-hover overflow-hidden">
            ...
            <div class="group relative" data-aos="fade-up" data-aos-delay="200">
                ...
                <a href="{{ route('assistance') }}" class="relative block bg-white rounded-3xl p-8 shadow-lg border border-slate-100 card-hover overflow-hidden">
...
<section class="py-24 bg-slate-50 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-12 gap-6" data-aos="fade-up">
            ...
            <a href="{{ route('classes') }}" class="inline-flex items-center gap-2 text-primary-600 font-semibold hover:text-primary-700 transition-colors group">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ route('classe.detail', $classe->id) }}" 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row justify-between items-center mb-12 gap-4" data-aos="fade-up">
            ...
            <div class="flex gap-2">
                <button class="px-4 py-2 rounded-full bg-primary-600 text-white text-sm font-medium">Tous</button>
                <button class="px-4 py-2 rounded-full bg-slate-100 text-slate-600 text-sm font-medium hover:bg-slate-200 transition-colors">Épreuves</button>
                <button class="px-4 py-2 rounded-full bg-slate-100 text-slate-600 text-sm font-medium hover:bg-slate-200 transition-colors">Cours</button>
            </div>
        </div>
            ...
            <div class="group bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100 card-hover" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-slate-100">
                        ...
                        <a href="{{ route('epreuve.detail', $epreuve->id) }}" class="text-primary-600 hover:text-primary-700">
                            <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
...
<section class="py-24 bg-gradient-to-br from-primary-600 to-primary-900 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10" data-aos="zoom-in">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('register') }}" class="bg-white text-primary-700 px-8 py-4 rounded-full font-bold text-lg hover:bg-primary-50 transition-all transform hover:scale-105 shadow-xl flex items-center justify-center gap-2 btn-shine">
                <i class="fas fa-rocket"></i>
                Commencer gratuitement
            </a>
            <a href="{{ route('classes') }}" class="border-2 border-white text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-white/10 transition-all flex items-center justify-center gap-2">
